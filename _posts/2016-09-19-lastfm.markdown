...
LastFM is a social network for exploring music. It integrates into MP3 players, and tracks the music played by its users. It then uses this data to make reccomendations to its users about the music they might enjoy. 
