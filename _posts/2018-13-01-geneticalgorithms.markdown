...
$$\underset{v,w}{\operatorname{argmax}} (\sum_{k=0}^N)v_kx_k)$$ 

subject to 

$$\sum_{k=0}^N)w_kx_k) \leq q$$ 

where $x_1,x_2,...,x_n$ are binary encoded decision values indicating whether 0 or 1 of item $k$ were selected.
